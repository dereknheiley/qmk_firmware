...
LSFT_T(KC_CAPS), KC_A  , KC_S  , KC_D  , KC_F  , KC_G  ,                         KC_H  , KC_J  , KC_K  , KC_L  ,KC_SCLN,RSFT_T(KC_QUOT),
        KC_LCPO, KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_N  , KC_M  ,KC_COMM,KC_DOT ,KC_SLSH,KC_RCPC,
                LCTL_T(KC_BSPC),LALT_T(KC_ESC),                                                  KC_MINS, KC_EQL,

//6-thumb
                                        // KC_LGUI,LT(1,KC_SPC),             LT(1,KC_BSPC), KC_DEL,
                                        //  KC_ENT,KC_ESC,                         KC_HOME, KC_ENT, //comment out for 2-thumb version
                                        // KC_BSPC, KC_DEL,                        MO(2) , KC_RALT  //comment out for 4-thumb version

//5-thumb
//                                           KC_NO,KC_LGUI,                         KC_DEL, KC_NO,
//                                    LT(1,KC_SPC),KC_ENT,                         KC_ENT , LT(1,KC_BSPC),
//                                         KC_BSPC, KC_ESC,                        KC_HOME, MO(2)

//3-thumb
                                        KC_LGUI,LT(1,KC_SPC),            LT(1,KC_BSPC), KC_DEL,
                                          KC_NO,KC_ENT,                        KC_HOME, KC_NO,  //comment out for 2-thumb version
